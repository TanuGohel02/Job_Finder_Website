    ...
    public partial class ResumeBuild : System.Web.UI.Page
    {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                if (Request.QueryString["id"] != null)
                {
                    ...
                    if (fuResume.HasFile)
                    {
                        ...
                        else
                        {
                            concatQuery = string.Empty;
                            lblMsg.Visible = true;
                            lblMsg.Text = "Please select .doc, .docx, .pdf for Resumes!";
                            lblMsg.CssClass = "alert alert-danger";
                        }  
                    }
                    else
                    ...
                    if (isValid)
                    {
                        ...
                        {
                            lblMsg.Visible = true;
                            lblMsg.Text = "Resume Details not updated, try again!";
                            lblMsg.CssClass = "alert alert-danger";
                        }
                    }
                }
                ...
                {
                    lblMsg.Visible = true;
                    lblMsg.Text = "Cannot update records, please try to <b>Relogin</b>!";
                    lblMsg.CssClass = "alert alert-danger";
                }
            }
            catch (SqlException ex)
            {
                ...
                {
                    lblMsg.Visible = true;
                    lblMsg.Text = "<b>" + txtUserName.Text.Trim() + "</b>  Username already exists! Please Try again. ";
                    lblMsg.CssClass = "alert alert-danger";
                }
                else
                {
