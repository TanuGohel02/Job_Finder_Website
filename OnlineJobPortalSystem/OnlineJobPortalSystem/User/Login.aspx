<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="OnlineJobPortalSystem.User.Login" %>
                    ...
                    <div class="col-lg-6 mx-auto">
                        <div class="form-contact contact_form">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <span class="clickLink"><a href="../User/Register.aspx">New User? Click here to Register.</a></span>
                            </div>
                        </div>
                    </div>
                </div>
