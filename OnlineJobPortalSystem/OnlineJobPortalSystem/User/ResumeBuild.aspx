<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="ResumeBuild.aspx.cs" Inherits="OnlineJobPortalSystem.User.ResumeBuild" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

     <section>
        <div class="container pt-50 pd-40">
            <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="form-contact contact_form">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label>Graduation with Points/Grade</label>
                                        <asp:TextBox ID="txtGraduation" runat="server" CssClass="form-control" 
                                            placeholder="Ex: BTech with 9.5 pointer" required>
                                        </asp:TextBox>
                                    </div>
                                </div>
                                 ...
                                 <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label>Post Graduation with Points/Grade</label>
                                        <asp:TextBox ID="txtPostGraduation" runat="server" CssClass="form-control" 
                                            placeholder="Ex: MTech with 9.5 pointer" required>
                                        </asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtPhd" runat="server" CssClass="form-control" placeholder="PHD with Grade required">
                                        </asp:TextBox>
                                    </div>
                                </div>
