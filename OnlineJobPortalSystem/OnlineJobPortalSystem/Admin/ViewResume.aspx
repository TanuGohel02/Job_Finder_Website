<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ViewResume.aspx.cs" Inherits="OnlineJobPortalSystem.Admin.ViewResume" %>
            ...
            <div class="row mb-3 pt-sm-3">
                <div class="col-md-12">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered"
                        ...
                        OnPageIndexChanging="GridView1_PageIndexChanging" DataKeyNames="AppliedJobs" OnRowDeleting="GridView1_RowDeleting"
                        ...
                        <Columns>
                            ...
                            <asp:CommandField CausesValidation="false" HeaderText="Delete Job" ShowDeleteButton="true" 
